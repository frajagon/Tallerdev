...
{{Form::open(array('action'=>array('App\http\Controllers\AcudienteController@update', $acudiente->id),'method'=>'patch', 'files'=>true))}}
<div class="row">
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        @if($acudiente->imagen)
        <img src="{{asset('../storage/app/public/'.$acudiente->imagen)}}" alt="" width="100%">
        @else
        ...
        <div class="row">
            <div class="col-lg-4 col-md-9 col-sm-6 col-xs-12">
                <div class="input-group mb-3">
                    ...
                    <input type="email" class="form-control" placeholder="Email de ingreso" aria-label="Username" aria-describedby="basic-addon1" name="usuario" id="usuario" value="@if ($acudiente->usuario) {{$acudiente->usuario->email}} @endif">
                </div>
            </div>
            <div class="col-lg-4 col-md-9 col-sm-6 col-xs-12">
                <div class="input-group mb-3">
